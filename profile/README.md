...
This organization is the operation's public map and front door. It hosts the official
documents of the practice — the Official Declarations of Production-Year
...
- **[AtmosphericsTheory](https://github.com/Historiotheque/AtmosphericsTheory)** — the theory research archive: atmosphere as a pressurized resonant field — daily field recordings, essays and liner notes, the concepts glossary, the phenomenology-of-electroacoustic bibliography, and the founding documents of Atmospheric Tone.
...
Browse the repositories above, enter through the projects index, or start with the latest Official Declaration.
